      ...
      <form action="{{ route('customer.update', ['id' => $customer->id]) }}" method="POST">
        ...
        <div class="space-y-12">
          <div class="border-b border-gray-900/10 pb-12">
            <h2 class="text-base/7 font-semibold text-gray-900">Ändra Kundinformation</h2>
            <p class="mt-1 text-sm/6 text-gray-600">Ändra information för en existerande kund.</p>
